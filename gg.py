...
while running:
    ...
    [pg.draw.rect(screen, "blue", (x * TSIDE, y * TSIDE, TSIDE - 1, TSIDE - 1)) for x, y in snake]
    ...
    if alive:
        ...
        text = font_space.render(f"Backspace для перезапуска", True, "white")
